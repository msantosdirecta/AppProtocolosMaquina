/**
 * Base de Dados Consolidada de Soluções de Conectividade Industrial (20 Soluções, 10 Critérios)
...
const PRESETS = [
  {
    ...
    weights: { cost: 5, cnc: 5, plc: 5, sf: 5, ease: 5, ext: 5, sec: 5, mat: 5, light: 5, standards: 5 }
  },
  {
    id: 'opensource',
    name: '🆓 Foco em Baixo Custo / Open Source',
    desc: 'Prioriza soluções gratuitas, leves e com padrões abertos',
    weights: { cost: 10, cnc: 3, plc: 6, sf: 7, ease: 8, ext: 8, sec: 7, mat: 5, light: 9, standards: 10 }
  },
  {
    id: 'cnc_plc',
    name: '🏭 Foco em Máxima Cobertura CNC & PLC',
    desc: 'Prioriza maior interoperabilidade com máquinas fabris heterogêneas',
    weights: { cost: 2, cnc: 10, plc: 10, sf: 8, ease: 5, ext: 7, sec: 8, mat: 9, light: 4, standards: 7 }
  },
  {
    id: 'resilience',
    name: '🛡️ Foco em Resiliência Offline (Store & Forward)',
    desc: 'Prioriza integridade total de dados e prevenção contra quedas de rede',
    weights: { cost: 4, cnc: 6, plc: 7, sf: 10, ease: 6, ext: 6, sec: 9, mat: 8, light: 5, standards: 8 }
  },
  {
    id: 'edge_light',
    name: '⚡ Foco em Leveza & Containers Edge',
    desc: 'Prioriza executáveis ultraleves e rápida implantação via Docker',
    weights: { cost: 7, cnc: 5, plc: 7, sf: 7, ease: 10, ext: 8, sec: 7, mat: 6, light: 10, standards: 8 }
  },
  {
    id: 'enterprise_sec',
    name: '🔒 Foco em Segurança Enterprise & Padronização',
    desc: 'Prioriza maturidade de mercado, conformidade TLS/SOC2 e modelo UNS',
    weights: { cost: 2, cnc: 7, plc: 9, sf: 9, ease: 6, ext: 8, sec: 10, mat: 10, light: 5, standards: 10 }
  }
];
...
const SOLUTIONS = [
  {
    ...
    scores: { cost: 3.5, cnc: 9.5, plc: 9.8, sf: 9.5, ease: 8.5, ext: 9.0, sec: 9.5, mat: 9.0, light: 7.5, standards: 9.5 },
  ...
  },
  {
    ...
    scores: { cost: 3.5, cnc: 9.5, plc: 9.8, sf: 9.0, ease: 8.5, ext: 9.0, sec: 9.5, mat: 10.0, light: 6.5, standards: 9.5 },
    summary: 'Padrão-ouro global de conectividade industrial com 150+ drivers, Fanuc FOCAS Suite, módulos IoT Gateway MQTT e resiliência comprovada.',
    details: {
  ...
  },
  {
    ...
    scores: { cost: 3.0, cnc: 9.5, plc: 9.8, sf: 9.5, ease: 8.0, ext: 8.5, sec: 9.5, mat: 9.8, light: 7.0, standards: 9.5 },
    summary: 'Plataforma IIoT no-code com 400+ drivers industriais, integração nativa Fanuc/Siemens/Rockwell e resiliência a falhas de rede.',
    details: {
  ...
  },
  {
    ...
    scores: { cost: 4.0, cnc: 7.5, plc: 9.0, sf: 9.5, ease: 9.0, ext: 9.0, sec: 9.0, mat: 8.5, light: 9.0, standards: 9.5 },
  ...
  },
  {
    ...
    scores: { cost: 10.0, cnc: 6.0, plc: 8.5, sf: 9.0, ease: 7.0, ext: 9.5, sec: 9.5, mat: 9.0, light: 7.5, standards: 9.5 },
    summary: 'Arquitetura de microsserviços open source da Linux Foundation para Edge Computing, desacoplamento total e segurança com Vault/Kong.',
    details: {
  ...
  },
  {
    ...
    scores: { cost: 8.0, cnc: 8.0, plc: 9.5, sf: 8.5, ease: 9.5, ext: 8.5, sec: 9.0, mat: 8.5, light: 10.0, standards: 9.5 },
    summary: 'Servidor de conectividade industrial ultraleve escrito em C (<10MB RAM), ideal para gateways de baixíssimo consumo de hardware.',
    details: {
  ...
  },
  {
    ...
    scores: { cost: 4.0, cnc: 6.5, plc: 8.5, sf: 9.0, ease: 9.0, ext: 9.0, sec: 9.5, mat: 8.5, light: 8.5, standards: 10.0 },
    summary: 'Plataforma líder em Industrial DataOps e Unified Namespace (UNS), com modelagem no-code de dados fabris e Store & Forward em disco.',
    details: {
  ...
  },
  {
    ...
    scores: { cost: 2.5, cnc: 6.5, plc: 9.0, sf: 9.5, ease: 7.5, ext: 9.0, sec: 10.0, mat: 9.0, light: 7.5, standards: 10.0 },
  ...
  },
  {
    ...
    scores: { cost: 4.5, cnc: 9.5, plc: 7.5, sf: 8.0, ease: 8.5, ext: 7.5, sec: 8.5, mat: 9.5, light: 7.5, standards: 8.5 },
  ...
  },
  {
    ...
    execType: 'Serviço Windows (GUI)',
    scores: { cost: 3.0, cnc: 8.5, plc: 9.8, sf: 9.0, ease: 8.0, ext: 8.5, sec: 9.5, mat: 10.0, light: 6.5, standards: 9.5 },
  ...
  },
  {
    ...
    scores: { cost: 5.0, cnc: 8.5, plc: 9.0, sf: 9.0, ease: 8.5, ext: 9.0, sec: 9.5, mat: 8.5, light: 7.5, standards: 9.5 },
  ...
  },
  {
    ...
    scores: { cost: 3.5, cnc: 8.0, plc: 9.5, sf: 9.5, ease: 8.0, ext: 9.0, sec: 9.5, mat: 9.8, light: 4.5, standards: 9.5 },
  ...
  },
  {
    ...
    scores: { cost: 10.0, cnc: 6.0, plc: 8.5, sf: 9.0, ease: 9.5, ext: 9.5, sec: 9.0, mat: 9.5, light: 9.5, standards: 9.5 },
  ...
  },
  {
    ...
    scores: { cost: 10.0, cnc: 5.5, plc: 8.0, sf: 7.0, ease: 9.5, ext: 10.0, sec: 8.0, mat: 9.0, light: 8.0, standards: 9.0 },
  ...
  },
  {
    ...
    execType: 'Serviço Windows (GUI)',
    scores: { cost: 4.0, cnc: 8.5, plc: 9.5, sf: 9.0, ease: 8.0, ext: 8.0, sec: 9.0, mat: 9.8, light: 6.5, standards: 9.0 },
  ...
  },
  {
    ...
    scores: { cost: 3.5, cnc: 6.0, plc: 9.0, sf: 9.0, ease: 7.5, ext: 8.5, sec: 9.5, mat: 10.0, light: 7.0, standards: 10.0 },
  ...
  },
  {
    ...
    scores: { cost: 3.0, cnc: 9.8, plc: 6.0, sf: 5.5, ease: 8.5, ext: 8.0, sec: 8.5, mat: 9.5, light: 8.5, standards: 7.5 },
  ...
  },
  {
    ...
    scores: { cost: 7.5, cnc: 6.0, plc: 8.5, sf: 8.0, ease: 8.0, ext: 9.5, sec: 8.5, mat: 8.5, light: 9.0, standards: 9.0 },
  ...
  },
  {
    ...
    scores: { cost: 10.0, cnc: 3.5, plc: 8.0, sf: 8.5, ease: 9.0, ext: 9.0, sec: 8.5, mat: 8.5, light: 7.5, standards: 9.0 },
  ...
  },
  {
    ...
    scores: { cost: 10.0, cnc: 3.0, plc: 8.5, sf: 4.0, ease: 6.0, ext: 9.5, sec: 8.5, mat: 8.5, light: 7.5, standards: 9.0 },
